...
research group has created a blockchain-based recording system for interactions, TrustChain. This system is 
...
This chapter introduces the concept of blockchains and the TrustChain architecture itself to the reader. 
