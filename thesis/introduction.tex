...
The sharing economy is a good example where trust needs to be built between strangers.
...
Commonly a system is referred to as a reputation system if it produces a score for an entity as 
